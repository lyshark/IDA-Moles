...
**Author's note:** This project was developed by an individual using their spare time and leisure time for nearly a month, and is positioned as a functional rapid validation prototype. The main difficulty in the development process lies in the extreme lack of interface information related to the new version of the C++SDK, as well as the deviation in the description of C++interfaces in official documents. The project code was summarized through continuous attempts. At present, there is still a lot of room for optimization and improvement in the code. Developers are welcome to communicate and discuss, submit PR, and jointly build iterations.
